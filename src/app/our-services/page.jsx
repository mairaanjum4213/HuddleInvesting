    ...
    return (
        <>
            ...
            <section className='bg-Green3 md:p-10 p-5' >
                <section className=' flex md:flex-row flex-col  gap-5 md:gap-32 md:text-justify'>
                    <div className=''>
                    ...
                    <Image
                        className='w-[15rem] h-[15rem] md:block hidden '
                ...
                <section className='md:my-10 my-5 flex md:flex-row flex-col  gap-5 md:gap-32 md:text-justify'>
                    <Image
                        className='w-[15rem] h-[15rem] md:block hidden '
                        src='/assets/image/our-services/CryptoCFDS.png'
                        alt=''
            ...
            <section className='md:p-10 p-5 flex md:flex-row flex-col  gap-5 md:gap-32 md:text-justify'
            >
                <div className=''>
