            ...
            <div className='flex flex-col items-center justify-center md:p-10 my-10 '>
                ...
                <div className="grid md:grid-cols-2 gap-5  md:gap-10 grid-cols-1 md:my-10 my-5">
                    <div className='bg-[#F3FFF3] md:p-10 md:w-[83%] md:justify-self-end p-5 flex-col  gap-2 rounded'>
                        ...
                        <button className="before:ease relative h-12 w-40 overflow-hidden border border-Green300 bg-Green300 text-white  transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700  hover:before:-translate-x-40">
                            Get Started
                        </button>
                    </div>
